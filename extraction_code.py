...
model_name_or_path = "hmart824/layoutlmv3-finetuned_0.1.1"  # Update with your model path
    ...
    for page_num in range(len(doc)):
        ...
        for sentence, bbox in sentences:
            ...
            encoding = processor(
                text=words,
                images=image,
                boxes=[normalize_bbox(bbox, width, height)] * len(words),
                return_tensors="pt",
                padding="max_length",
                truncation=True
            )
...
def main():
    pdf_path = "./T.S-GWR binaya modified 8.pdf"  # Update with your PDF file path
